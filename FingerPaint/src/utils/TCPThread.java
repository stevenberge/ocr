...
public class TCPThread implements Runnable {
	...
	/* Variables */
	private String ipAdd = "10.254.146.245";//"10.7.77.173";//
	 ...
	 * @param c
	 */
	private void updateDisplay(Bitmap b) {///////////////返回处理过的图片
...
//			Log.i(TAG, "Reading Data... ");
			updateState("data receving");
			Log.i(TAG,"data receving");
			
//			dataInputStream.readFully(inData);
//			Log.i(TAG, "Received Data... Displaying");
//			updateState("data recved");
...
// 			Receiving Answer
			...
			Byte ans =dataInputStream.readByte();
			Log.i(TAG,"answer:"+ans);
			updateAns(ans+"");
		} catch (Exception e) {
